...
SELECT CONCAT('The amount of days ',first_name,' ',last_name,' has been working for the company is ',DATEDIFF(CURRENT_DATE,hire_date)) FROM employees WHERE (hire_date >= '1990-01-01' AND hire_date < '2000-01-01') AND birth_date LIKE '%-12-25' ORDER BY birth_date, hire_date DESC;
